...
cyoAdventure = function(a) {
    ...
    if (ans === 4001) {
        ...
        campaignTrail_temp.answer_feedback_json.find(entry => entry.pk===5014).fields.answer_feedback="You seem to play the long game – this might get more first-time voters to the polls, but is that enough for you? Rezo declines to endorse anyone and the electorate skews older in almost every election. At the very least, by taking a step back, you’ve found some inconsistencies in your CV that are now fixed. If anyone takes you to task over it, you’ve made some new friends in the media."
