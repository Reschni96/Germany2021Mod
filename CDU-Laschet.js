...
cyoAdventure = function(a) {
    ...
    if(campaignTrail_temp.question_number===28){
            ...
            if (statesman> 14) {
                ...
                campaignTrail_temp.answers_json.find(item => item.pk === 4666).fields.question = '';
                campaignTrail_temp.answers_json.find(item => item.pk === 4667).fields.question = '';
