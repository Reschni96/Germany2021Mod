     ...
     if (playerParty.electoral_votes>totalSeats/2){
       ...
       if(firstParty.pk===304){
    	...
    	if (playerParty.electoral_votes == e.final_overall_results[1].electoral_votes){
        	...
        	playerPerformance = "The first reaction to the election results at the party headquarters is - not even shock. It’s despondence. The projections at the start of the race were grim - they thought, with you, maybe the party’s identity, between reason and progress, could proliferate. But it didn’t. The doubters were right. The critics had won out. The Grand Old Dame, the SPD, is weakening. You have tumbled into third place, with a result en par with those during the German Empire’s sham elections. During the election night, there are loud calls for your resignation, not just from the left wing of your party - although with the support of the party elite, you manage to salvage whatever influence you have left.<br> The " + firstParty.fields.last_name + " will try to form a government now. For the SPD, one thing is clear: Another coalition with the CDU/CSU can't be an option, but for you, that’s not of much relevance. You would do best to regenerate yourself in the opposition - or else, the fate of the party looks eerily similar to that of France’s Parti Socialiste. Social Democracy remains in crisis, for now."
        	badResult = true;
        	possibleCoalitions = possibleCoalitions.filter((coalition) => {
          	return !(coalition.parties.includes(playerParty.candidate) && coalition.parties.includes(77));
        	});
