...
if (campaignTrail_temp.question_number === 27) {
    ...
    if ([4520, 4521, 4522, 4523].includes(ans)) {
        if (pop_vote[2].pvp-playerPolling>0.015) {
       campaignTrail_temp.questions_json[24]=extraQuestions[4];
        }
        else{
            changeGlobalEffect(78,4523,0.07)
            changeGlobalEffect(78,4524,0.07)
            changeGlobalEffect(78,4525,0.07)
            changeGlobalEffect(78,4526,0.07)
            changeGlobalEffect(79,4523,-0.07)
            changeGlobalEffect(79,4524,-0.07)
            changeGlobalEffect(79,4525,-0.07)
            changeGlobalEffect(79,4526,-0.07)
