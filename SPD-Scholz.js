...
if (campaignTrail_temp.question_number === 27) {
    ...
    if(competence>19 &&!firedKeys[27]&&!campaignTrail_temp.player_answers.includes(4115)){
     ...
     if(FisCon>5 && !firedKeys[50]&&!campaignTrail_temp.player_answers.includes(4095)){
        ...
        changeGlobalEffect(79,4095, 0.008)
     }
     if(FisCon>8 && !firedKeys[51]&&!campaignTrail_temp.player_answers.includes(4095)){
        ...
        changeGlobalEffect(304,4095, 0.018)
     }
    ...
    if(SocCon>4 && !firedKeys[65]&&!campaignTrail_temp.player_answers.includes(4529)){
        firedKeys[65] = true;
        answerSwapper(4531, 4222, false);
        changeGlobalEffect(78,4529, -0.05)
        changeGlobalEffect(78,4531, -0.04)
    }
    ...
    if(campaignTrail_temp.question_number === 18){
       ...
       if (merkelism>15 && !firedKeys[67]){
            ...
            changeGlobalEffect(78,4529, 0.01)
        }
    ...
    if(campaignTrail_temp.question_number === 23){
     ...
     if(campaignTrail_temp.question_number === 23){
      ...
      if (merkelism<5&&!firedKeys[70]){
            ...
            changeGlobalEffect(78, 4120, 0.01)
             changeGlobalEffect(77, 4120, -0.005)
             changeGlobalEffect(79, 4120, -0.005)
        }
     }
    ...
    if(ans===4501){
        campaignTrail_temp.questions_json[1].fields.description="The race takes shape, as Kevin Kühnert orchestrates a leftist top candidacy, consisting of Saskia Esken and Norbert Walter-Borjans. With eight notable duos running, there will be a run-off decidingbetween  the final two. You and Gesine Schwan are the only trans-sectional ticket, but both of you are seen as candidates of the past. What approach do you take to convince the party members to vote for you regardless?"
...
function reapplyTooltips(answer) {
    ...
    answer.fields.activeHints.forEach(hint => {
        const tooltipContent = `
            <span class='mytooltip' style='background-color: red'>
                [A]
