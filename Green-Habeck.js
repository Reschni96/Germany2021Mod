...
cyoAdventure = function(a) {
	...
	if (ans === 4000) {
	    campaignTrail_temp.questions_json[10]=extraQuestions[0];
	}
    ...
    if ([4503, 4501, 4003, 4009, 4014, 4016, 4019, 4506, 4021, 4031, 4040].includes(ans)) {
        ideologyLeft += 1
    }
